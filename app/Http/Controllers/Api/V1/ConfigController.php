...
//        }
        ...
        return response()->json([
            ...
            'per_km_shipping_charge' => (double)(isset($settings['per_km_shipping_charge']) ? $settings['per_km_shipping_charge'] : 0),
            'minimum_shipping_charge' => (double)(isset($settings['minimum_shipping_charge']) ? $settings['minimum_shipping_charge'] : 0),
...
//            'landing_page_settings_full_url'=> $data['web_app_landing_page_settings_storage']??'public',
            ...
            'category_list' => (int)(isset($settings['category_list']) ? $settings['category_list'] : 1),
            'best_stores_nearby' => (int)(isset($settings['best_stores_nearby']) ? $settings['best_stores_nearby'] : 1),
            'recommended_store' => (int)(isset($settings['recommended_store']) ? $settings['recommended_store'] : 1),
            'special_offers' => (int)(isset($settings['special_offers']) ? $settings['special_offers'] : 1),
            'most_popular_item' => (int)(isset($settings['most_popular_item']) ? $settings['most_popular_item'] : 1),
            'best_reviewed_item' => (int)(isset($settings['best_reviewed_item']) ? $settings['best_reviewed_item'] : 1),
            'just_for_you' => (int)(isset($settings['just_for_you']) ? $settings['just_for_you'] : 1),
            'new_on_lalengi' => (int)(isset($settings['new_on_lalengi']) ? $settings['new_on_lalengi'] : 1),
            'category_subcategory_product_list' => (int)(isset($settings['category_subcategory_product_list']) ? $settings['category_subcategory_product_list'] : 1),
            'all_stores' => (int)(isset($settings['all_stores']) ? $settings['all_stores'] : 1),
            'product_search_list' => (int)(isset($settings['product_search_list']) ? $settings['product_search_list'] : 1),
            'basic_medicine_nearby' => (int)(isset($settings['basic_medicine_nearby']) ? $settings['basic_medicine_nearby'] : 1),
            'common_condition' => (int)(isset($settings['common_condition']) ? $settings['common_condition'] : 1),
            'brand' => (int)(isset($settings['brand']) ? $settings['brand'] : 1),
            'brand_wise_product_list' => (int)(isset($settings['brand_wise_product_list']) ? $settings['brand_wise_product_list'] : 1),
            'top_offer_near_me' => (int)(isset($settings['top_offer_near_me']) ? $settings['top_offer_near_me'] : 1),
        ]);
    }
