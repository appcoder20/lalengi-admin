...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => ['module:order']], function () {
            ...
            Route::get('get-coordinates', 'OrderController@getCoordinates')->name('get-coordinates');
        ...
        Route::group(['prefix' => 'dispatch', 'as' => 'dispatch.'], function () {
            ...
            Route::get('deliveryman-list', 'DashboardController@get_delivery_man_list')->name('deliveryman_list');
