                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title">{{ translate('Priority Set Up Features') }}</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'category_list',
                                            'label' => translate('Category List'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'best_stores_nearby',
                                            'label' => translate('Best Stores Nearby'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'recommended_store',
                                            'label' => translate('Recommended Store'),
                                        ])
                                    </div>
                                    ...
                                    <div class="row g-3 align-items-end mt-2">
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'special_offers',
                                            'label' => translate('Special Offers'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'most_popular_item',
                                            'label' => translate('Most Popular Item'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'best_reviewed_item',
                                            'label' => translate('Best Reviewed Item'),
                                        ])
                                    </div>
                                    ...
                                    <div class="row g-3 align-items-end mt-2">
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'just_for_you',
                                            'label' => translate('Just for You'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'new_on_lalengi',
                                            'label' => translate('New on Lalengi'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'category_subcategory_product_list',
                                            'label' => translate('Category / Subcategory wise product list'),
                                        ])
                                    </div>
                                    ...
                                    <div class="row g-3 align-items-end mt-2">
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'all_stores',
                                            'label' => translate('All Stores'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'product_search_list',
                                            'label' => translate('Product search list'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'basic_medicine_nearby',
                                            'label' => translate('Basic Medicine Nearby'),
                                        ])
                                    </div>

                                    <div class="row g-3 align-items-end mt-2">
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'common_condition',
                                            'label' => translate('Common Condition'),
                                        ])
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'brand',
                                        ...
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'brand_wise_product_list',
                                            'label' => translate('Brand wise product list'),
                                        ])
                                    </div>

                                    <div class="row g-3 align-items-end mt-2">
                                        @include('admin-views.business-settings.partials.toggle', [
                                            'key' => 'top_offer_near_me',
                                            'label' => translate('Top offer near me'),
                                        ])
                                    </div>
                                </div>
